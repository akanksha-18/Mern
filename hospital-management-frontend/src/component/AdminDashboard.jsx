...
const AdminDashboard = () => {
    ...
    const updateDoctor = async () => {
        ...
        try {
            const response = await axios.put(`http://localhost:4000/api/superadmin/doctors/${editingDoctorId}`,
                {
                    name: doctorName,
                    specialization: doctorSpecialization,
                    email: doctorEmail,
    ...
    const updatePatient = async () => {
        ...
        try {
            const response = await axios.put(`http://localhost:4000/api/superadmin/patients/${editingPatientId}`,
                {
                    name: patientName,
                    email: patientEmail,
                    password: patientPassword
    ...
    return (
        <div className="container mx-auto">
            ...
            <div className="mb-4">
                ...
                <input type="text" placeholder="Specialization" value={doctorSpecialization} onChange={(e) => setDoctorSpecialization(e.target.value)} />
                <input type="email" placeholder="Email" value={doctorEmail} onChange={(e) => setDoctorEmail(e.target.value)} />
                <input type="password" placeholder="Password" value={doctorPassword} onChange={(e) => setDoctorPassword(e.target.value)} />
                <div className="mt-4">
                    {editingDoctorId ? (
            ...
            <h2 className="text-xl font-semibold mb-4 mt-8">Patients</h2>
            <div className="mb-4">
                ...
                <input type="password" placeholder="Password" value={patientPassword} onChange={(e) => setPatientPassword(e.target.value)} />
                <div className="mt-4">
                    {editingPatientId ? (
