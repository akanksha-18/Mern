  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-gradient-to-r from-blue-100 to-blue-300">
      <form onSubmit={bookAppointment} className="bg-gray-100 p-8 rounded-lg shadow-lg w-96">
        ...
        {doctors.length > 0 ? (
          <>
            <label htmlFor="doctor-select" className="block mb-2 font-medium text-gray-700">Select Doctor:</label>
            <select
              id="doctor-select"
              value={doctorId}
              onChange={(e) => setDoctorId(e.target.value)}
            ...
            <label htmlFor="date-picker" className="block mb-2 font-medium text-gray-700">Select Date and Time:</label>
            <DatePicker
              id="date-picker"
              selected={selectedDate}
              onChange={(date) => setSelectedDate(date)}
